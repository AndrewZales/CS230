...
if (mysqli_num_rows($result)>0){
   ...
   <div class="media">
       ...
       <div class="media-body">
           ...
           Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulurn in vulputate al. tempus vivierra turpis. Fusce condimentum nunc ac nisi vulputate tringilla. Donec lacinia congue felis in faucibus.
      <p>'.$row['revdate'].'</p>
      <p>'.$row['reviewtext'].'</p>
